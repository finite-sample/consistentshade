"""Sharpness-Aware Minimization training."""

import torch
import torch.nn.functional as F
from torch.utils.data import DataLoader, RandomSampler

from ..config import CLASSIFICATION_CONFIG, REGRESSION_CONFIG, SAM_CONFIG
...
def train_sam_regression(
    ...
    FIX: Explicit zero_grad before first loss.backward().
    """
